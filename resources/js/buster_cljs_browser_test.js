...
buster.spec.describe("is macro with exception features", function() {
  buster.spec.describe("assertions with `thrown?'", function() {
    buster.spec.it("simple example", function() {
      try {
        ...
        buster.assert(b, [cljs.core.str(c), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'clojure.core/instance?", "\ufdd1'js/Error", "\ufdd1'e4064")), cljs.core.str(", got "), cljs.core.str(b)].join(""))
      }
      return null
    });
    buster.spec.it("using function", function() {
      try {
        ...
        buster.assert(b, [cljs.core.str(c), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'clojure.core/instance?", "\ufdd1'js/Error", "\ufdd1'e4065")), cljs.core.str(", got "), cljs.core.str(b)].join(""))
      }
      return null
    });
    return null
  ...
  buster.spec.it("assertions with `thrown-with-msg?'", function() {
    try {
      ...
      var b = cljs.core.instance_QMARK_.call(null, Error, a), c = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
      buster.assert(b, [cljs.core.str(c), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'cljs.core/instance?", "\ufdd1'js/Error", "\ufdd1'e4066")), cljs.core.str(", got "), cljs.core.str(b)].join(""));
      b = cljs.core.re_find.call(null, /another error/, a.message);
      c = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
      buster.assert(b, [cljs.core.str(c), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'cljs.core/re-find", /another error/, cljs.core.list("\ufdd1'.-message", "\ufdd1'e4066"))), cljs.core.str(", got "), cljs.core.str(b)].join(""))
    }
    return null
  });
  return null
